...
var DashPdfComponents = /*#__PURE__*/function (_Component) {
  ...
  function DashPdfComponents() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateAnnotationReview", function (id, status) {
      ...
      var newDocTable = Object.assign({}, _this.state.documentTable);
      newDocTable[_this.props.pdfRendered].highlightsArr[0].creator.isCorrect = status;
      newDocTable[_this.props.pdfRendered].highlightsArr[0].creator.isReviewed = true;

      _this.setState({
        highlightsDict: newDict,
        documentTable: newDocTable
      });
      ...
      console.log(_this.state.documentTable[_this.props.pdfRendered].highlightsArr[0].creator);
      console.log(_this.props.documentTable);
    });
  ...
  _createClass(DashPdfComponents, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          documentTable = _this$props.documentTable,
          toggle = _this$props.toggle,
          showImpact = _this$props.showImpact; // console.log(this.props.pdfRendered);
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_adobe_react_spectrum__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
        theme: _adobe_react_spectrum__WEBPACK_IMPORTED_MODULE_5__["lightTheme"],
        colorScheme: "light"
        ...
        showImpact: this.props.showImpact
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: id,
...
DashPdfComponents.propTypes = {
  ...
  showImpact: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.bool,
...
//# sourceMappingURL=a924189-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhOTI0MTg5LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==