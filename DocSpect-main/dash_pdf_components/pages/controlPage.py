...
dfUserActivity = json.load(open('assets/files/studyFiles/userDataTestCondition.json'))
...
testingSection=  html.Div([
                        html.Div([
                            html.A(dbc.Button('Finish and Exit', id='submitAnswerControl', n_clicks=0, style={"width":"150px"}),href="/thankYouPage")
...
layout = html.Div(
    [
        ...
        dbc.Row(pdf_viewer),
        dcc.Store(id='dataStoreControl',data=dfUserActivity)
    ]
)
